      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div>
              ...
              <dd className="font-medium text-gray-900 mt-0.5">{order.customer?.phone ?? 'N/A'}</dd>
            </div>
            <div className="col-span-2">
              <dt className="text-gray-500">Delivery Address</dt>
              <dd className="font-medium text-gray-900 mt-0.5">{order.deliveryAddress}, {order.deliveryCity}</dd>
            </div>
            {order.deliveryNotes && (
              <div className="col-span-2">
                <dt className="text-gray-500">Delivery Notes</dt>
                <dd className="font-medium text-gray-900 mt-0.5">{order.deliveryNotes}</dd>
              </div>
            )}
          </dl>
        </div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          ...
          <div className="mt-4 pt-4 border-t border-gray-100 space-y-2 text-sm">
            ...
            <div className="flex justify-between text-gray-600"><span>Delivery Fee</span><span>{formatCurrency(order.deliveryFee)}</span></div>
